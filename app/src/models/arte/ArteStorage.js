...
exports.postData = async(data, nickname, image) => { 
    ...
    return new Promise((resolve, reject) => {
        const query = "INSERT INTO arteboard (title, content, nickname, instructor_name, category, edu_period, recruit_num, receipt_period, location, status, POST_DATE, filename) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);"
            const dbdata = [
                data.title,
                data.content,
                nickname,
